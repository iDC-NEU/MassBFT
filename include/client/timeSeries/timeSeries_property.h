...
namespace client::timeSeries {
    class TimeSeriesProperties : public core::BaseProperties<TimeSeriesProperties> {
    public:
        constexpr static const auto PROPERTY_NAME = "timeSeries";
    ...
    public:
        ...
        explicit TimeSeriesProperties(const YAML::Node& node) :core::BaseProperties<TimeSeriesProperties>(node) { }
    };
