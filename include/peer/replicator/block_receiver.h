...
namespace peer {
    ...
    public:
        ...
        void activeStart(proto::BlockNumber startAt, const ValidateFunc& onBlockValidate=nullptr) {
        ...
        void passiveStart(proto::BlockNumber startAt, const ValidateFunc& onBlockValidate=nullptr) {
