...
namespace client::timeSeries {
    core::Status DBWrapper::read(const std::string& table, const std::string& key, const std::vector<std::string>& fields) {
        ...
        return db->sendInvokeRequest(InvokeRequestType::TIMESERIES, InvokeRequestType::READ, data);
    }
    ...
    core::Status DBWrapper::scan(const std::string &table,
        ...
        return db->sendInvokeRequest(InvokeRequestType::TIMESERIES, InvokeRequestType::SCAN, data);
    }
    ...
    core::Status DBWrapper::update(const std::string& table, const std::string& key, const utils::ByteIteratorMap& values) {
        ...
        return db->sendInvokeRequest(InvokeRequestType::TIMESERIES, InvokeRequestType::UPDATE, data);
    }
    ...
    core::Status DBWrapper::readModifyWrite(const std::string &table, const std::string &key,
        ...
        return db->sendInvokeRequest(InvokeRequestType::TIMESERIES, InvokeRequestType::READ_MODIFY_WRITE, data);
    }
    ...
    core::Status DBWrapper::insert(const std::string &table, const std::string &key, const utils::ByteIteratorMap &values) {
        ...
        return db->sendInvokeRequest(InvokeRequestType::TIMESERIES, InvokeRequestType::INSERT, data);
    }
    ...
    core::Status DBWrapper::remove(const std::string &table, const std::string &key) {
        ...
        return db->sendInvokeRequest(InvokeRequestType::TIMESERIES, InvokeRequestType::DELETE, data);
    }
}