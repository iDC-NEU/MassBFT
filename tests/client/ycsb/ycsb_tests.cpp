...
protected:
    void SetUp() override {
        ...
        client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::BENCHMARK_SECONDS_PROPERTY, 20);
    ...
    static void SetupDefaultSingleWorkloadParam() {
        client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::RECORD_COUNT_PROPERTY, 100);

        client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_PROPORTION_PROPERTY, 0.00);
        client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::UPDATE_PROPORTION_PROPERTY, 0.00);
        client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::INSERT_PROPORTION_PROPERTY, 0.00);
        client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::SCAN_PROPORTION_PROPERTY, 0.00);
        client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READMODIFYWRITE_PROPORTION_PROPERTY, 0.00);
    }
...
TEST_F(YCSBTest, BasicTest) {
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_PROPORTION_PROPERTY, 1.00);
...
TEST_F(YCSBTest, TwoWorkerTest) {
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_PROPORTION_PROPERTY, 1.00);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::THREAD_COUNT_PROPERTY, 2);
    auto* p = util::Properties::GetProperties();
    tests::peer::Peer peer(*p, false, false);
    client::ycsb::YCSBEngine engine(*p);
    engine.startTest();
...
TEST_F(YCSBTest, OneWorkerPerformanceTest) {
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_PROPORTION_PROPERTY, 1.00);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::TARGET_THROUGHPUT_PROPERTY, 10000);
...
TEST_F(YCSBTest, OverloadTest) {
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_PROPORTION_PROPERTY, 1.00);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::TARGET_THROUGHPUT_PROPERTY, 300000);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::THREAD_COUNT_PROPERTY, 10);
...
TEST_F(YCSBTest, ReadOneFieldTest) {
    ...
    // set read proportion
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_PROPORTION_PROPERTY, 1.00);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_ALL_FIELDS_PROPERTY, false);
...
TEST_F(YCSBTest, InsertWorkloadTest) {
    ...
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::INSERT_PROPORTION_PROPERTY, 1.00);
...
TEST_F(YCSBTest, RMWWorkloadTest) {
    SetupDefaultSingleWorkloadParam();
    // set insert proportion
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READMODIFYWRITE_PROPORTION_PROPERTY, 1.00);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_ALL_FIELDS_PROPERTY, false);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::WRITE_ALL_FIELDS_PROPERTY, false);
...
TEST_F(YCSBTest, RMWWorkloadTest2) {
    ...
    // set insert proportion
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READMODIFYWRITE_PROPORTION_PROPERTY, 1.00);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::READ_ALL_FIELDS_PROPERTY, true);
    client::ycsb::YCSBProperties::SetProperties(client::ycsb::YCSBProperties::WRITE_ALL_FIELDS_PROPERTY, true);
